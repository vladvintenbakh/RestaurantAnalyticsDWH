...
from helpers.stg_settings_repository import EtlSetting, StgEtlSettingsRepository
from helpers.pg_saver import PgSaver
from helpers.users_reader import UsersReader
from helpers.pg_connect import PgConnect
from helpers.dict_util import json2str
...
class UsersLoader:
    ...
    WF_KEY = "mongodb_users_to_stg"
    LAST_LOADED_TS_KEY = "last_loaded_ts"

    def __init__(self, collection_loader: UsersReader, pg_dest: PgConnect, pg_saver: PgSaver, logger: Logger) -> None:
    ...
    def run_copy(self) -> int:
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_users(conn, str(d["_id"]), d["update_ts"], d)
